...
$from_email = 'erik.nerhus@esna.no'; //Webmaster email
...
$smtp_user = ''; // Legg inn epost addresse som sender vertifikasjon
$smtp_pw = ''; // Legg inn passord til valgt epost addresse
